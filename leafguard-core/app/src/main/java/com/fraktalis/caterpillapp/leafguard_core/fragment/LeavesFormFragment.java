...
public class LeavesFormFragment extends Fragment {
    ...
    private com.fraktalis.caterpillapp.leafguard_core.model.manager.UserManager userManager;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        userManager = com.fraktalis.caterpillapp.leafguard_core.model.manager.UserManager.getInstance();
